...
def uncertain_expansion(eq, ss, var_shape, args, gc, gk, cmk_app, approach = '1', init_util = None, iter_tol = 1e-8, max_iter = 50):
    """
    ...
    ## Take derivative of equilibrium conditions with respect to [JX_t, JX_tp1, W_tp1, q] at the steady-state
    recursive_ss = ss(*args, return_recursive=True)[:2]
    df, ss = take_derivatives(eq, ss, var_shape, True, 'None', recursive_ss, args)
    ...
    H_fun_list = [(lambda y: (lambda JX_t, JX_tp1, W_tp1, q, *args: eq(JX_t, JX_tp1, W_tp1, q, 'H', recursive_ss, *args)[y]))(i) for i in range(n_J)]
    H0_t = [approximate_fun(H_fun, ss, (1, n_X, n_W), None, None, None, None, args, second_order = False, zeroth_order= True) for H_fun in H_fun_list]

    L_fun_list = [(lambda y: (lambda JX_t, JX_tp1, W_tp1, q, *args: eq(JX_t, JX_tp1, W_tp1, q, 'L', recursive_ss, *args)[y]))(i) for i in range(n_J)]
    L0_t = [approximate_fun(L_fun, ss, (1, n_X, n_W), None, None, None, None, args, second_order = False, zeroth_order= True) for L_fun in L_fun_list]
    ...
    while error > iter_tol and i < max_iter:
        if approach == '1':
            J1_t, JX1_t, JX1_tp1, JX1_tp1_tilde, X1_tp1, X1_tp1_tilde = first_order_expansion_approach_1(df, ss, util_sol, var_shape, H0_t, L0_t, recursive_ss, args)
            adj = compute_adj_approach_1(H_fun_list, ss, eq, var_shape, util_sol, JX1_t, X1_tp1, recursive_ss, args)
        ...
        util_sol = solve_utility(ss, var_shape, args, X1_tp1, X2_tp1, JX1_t, JX2_t, gc, gk, cmk_app)
...
def take_derivatives(eq, ss, var_shape, second_order, mode, recursive_ss,
                      args):
    ...
    dfq = compute_derivatives(f = lambda Var_t, Var_tp1, W_tp1,  q:
                            anp.atleast_1d(eq(Var_t, Var_tp1, W_tp1, q, mode, recursive_ss, *args)),
                             X=[ss, ss, W_0, q_0],
...
def first_order_expansion_approach_1(df, ss, util_sol, var_shape, H0, L0, recursive_ss, args):
    """
...
def compute_adj_approach_1(H_fun_list, ss, eq, var_shape, util_sol, JX1_t, X1_tp1, recursive_ss, args):
    """
    ...
    H0_t = [approximate_fun(H_fun, ss, (1, n_X, n_W), None, None, None, None, args, second_order = False, zeroth_order= True) for H_fun in H_fun_list]
    H1_t = [approximate_fun(H_fun, ss, (1, n_X, n_W), JX1_t, None, X1_tp1, None, args, second_order = False, zeroth_order= False) for H_fun in H_fun_list]

    L_fun_list = [(lambda y: (lambda JX_t, JX_tp1, W_tp1, q, *args: eq(JX_t, JX_tp1, W_tp1, q, 'L', recursive_ss, *args)[y]))(i) for i in range(n_J)]
    L0_t = [approximate_fun(L_fun, ss, (1, n_X, n_W), None, None, None, None, args, second_order = False, zeroth_order= True) for L_fun in L_fun_list]
    L1_t = [approximate_fun(L_fun, ss, (1, n_X, n_W), JX1_t, None, X1_tp1, None, args, second_order = False, zeroth_order= False) for L_fun in L_fun_list]
...
def solve_utility(ss, var_shape, args, X1_tp1, X2_tp1, JX1_t, JX2_t, gc, gk, cmk_app, tol = 1e-10):
    """
    ...
    cmk_app = approximate_fun(cmk_app, ss, (1, n_X, n_W), JX1_t, JX2_t, X1_tp1, X2_tp1, args, second_order = True, zeroth_order=False)
    cmk1_t = cmk_app[2]
    cmk2_t = cmk_app[3]
    ...
    gc_tp1_approx = approximate_fun(gc, ss, (1, n_X, n_W), JX1_t, JX2_t, X1_tp1, X2_tp1, args, second_order = True, zeroth_order=False)
    ...
    ## Approximate the growth of consumption
    gk_tp1_approx = approximate_fun(gk, ss, (1, n_X, n_W), JX1_t, JX2_t, X1_tp1, X2_tp1, args, second_order = True, zeroth_order=False)
