...
def uncertain_expansion(eq, ss, var_shape, args, gc, init_util = None, iter_tol = 1e-8, max_iter = 50):
    ...
    ----------
    eq_cond : callable
        Returns [Qpsi_1-psi_2,phi] Qpsi_1-psi_2 satisfy the forward-looking equations 
        E[N Q psi_1-psi_2]=0, and phi satisfy the state equations phi=0.
        ...
        Note that in Var_t and Var_tp1, state variables must follow endogenous variables. 
